...
public class WebSocketHandlerClient extends WebSocketClient implements Closeable {
    ...
    public static WebSocketHandlerClient newInstance(String serverUri, String token) throws URISyntaxException {
    ...
    private WebSocketHandlerClient(String serverUri, Map<String,String> headers) throws URISyntaxException {
