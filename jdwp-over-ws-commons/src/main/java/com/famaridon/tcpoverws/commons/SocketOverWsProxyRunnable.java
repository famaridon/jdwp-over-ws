...
public class SocketOverWsProxyRunnable implements Runnable, Closeable, MessageHandler {
    ...
    public SocketOverWsProxyRunnable(SocketOverWsProxyConfiguration configuration, WebSocketWrapper ws) throws IOException {
    ...
    public SocketOverWsProxyRunnable(SocketOverWsProxyConfiguration configuration, SocketChannel socket, WebSocketWrapper ws) throws IOException {
        this.configuration = configuration;
        this.ws = ws;
        this.socket = socket;
        this.buffer = ByteBuffer.allocate(this.configuration.getBufferSize());
